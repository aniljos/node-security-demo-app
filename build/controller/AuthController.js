...
exports.refreshToken = exports.authorizeProducts = exports.loginAction = void 0;
...
function loadUsers() {
    users = [];
    users.push({ name: "anil", password: "anil" });
    users.push({ name: "demo", password: "demo" });
    users.push({ name: "abc", password: "abc" });
}
loadUsers();
